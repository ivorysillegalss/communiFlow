...
public class ReadFileUtils {
     ...
     */
    @Deprecated
    public static List<CrowdInfo> getCsvRowList(String path) {
        List<CrowdInfo> result = new ArrayList<>();
        try {
            ...
            for (int i = 1; i < data.getRowCount(); i++) {
                ...
                result.add(CrowdInfo.builder().receiver(CollUtil.getFirst(row.iterator())).params(param).build());
            }
